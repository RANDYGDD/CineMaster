...
<head>
    ...
    <title><?php echo 'Administrador: '.$_SESSION['admin']; ?></title>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Datos</strong> Mostrando <a href="http://startbootstrap.com/template-overviews/sb-admin-2" class="alert-link">SB Admin 2</a> Nuevas adicciones
                        </div>
                    </div>
                </div>
                <!-- /.row -->
                ...
                <div class="row">
                        ...
                        <div class="panel panel-primary">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Contenidos</span>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-green">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Imagenes/Videos</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="panel panel-red">
                            ...
                            <a href="#">
                                <div class="panel-footer">
                                    <span class="pull-left">Bancos</span>
                                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                    <div class="clearfix"></div>
                                </div>
                            </a>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o fa-fw"></i>Grafico de area</h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i>Grafico pastel</h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-clock-o fa-fw"></i>Panel del tarea</h3>
                            </div>
                            <div class="panel-body">
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <span class="badge">ahora mismo</span>
                                        <i class="fa fa-fw fa-calendar"></i> Calendario actulizado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">4 minutos atras</span>
                                        <i class="fa fa-fw fa-comment"></i> posteado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">23 minutos atras</span>
                                        <i class="fa fa-fw fa-truck"></i> ordenado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">46 minutos</span>
                                        <i class="fa fa-fw fa-money"></i> posteado
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">1 hora atras</span>
                                        <i class="fa fa-fw fa-user"></i> nuevas peliculas
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">2 horas</span>
                                        <i class="fa fa-fw fa-check"></i> completar compra
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">ayer</span>
                                        <i class="fa fa-fw fa-globe"></i> coferencia medio ambiente
                                    </a>
                                    <a href="#" class="list-group-item">
                                        <span class="badge">dos dias</span>
                                        <i class="fa fa-fw fa-check"></i> arreglar errores del proyector
                                    </a>
                                </div>
                                <div class="text-right">
                                    <a href="#">Ver todas la actividades<i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="#">Ver toda las transacciones <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
