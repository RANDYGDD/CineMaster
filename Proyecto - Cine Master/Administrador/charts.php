       ...
       <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
           ...
           <div class="navbar-header">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i>L<?php echo $_SESSION['admin']; ?><b class="caret"></b></a>
            ...
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Ejemplo Grafico de linea</h3>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Ejemplo grafico de paster</h3>
                            </div>
                            <div class="panel-body">
                                <div class="flot-chart">
                    ...
                    <div class="col-lg-8">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Ejemplos grafica multiples ejes</h3>
                            </div>
                            <div class="panel-body">
                                <div class="flot-chart">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Ejmplos graficos de lienas de movimiento</h3>
                            </div>
                            <div class="panel-body">
                                <div class="flot-chart">
                    ...
                    <div class="col-lg-6">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Grafico de barras con tips</h3>
                            </div>
                            <div class="panel-body">
                                <div class="flot-chart">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="panel panel-green">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i>Ejemplo Grafico de areas</h3>
                            </div>
                            <div class="panel-body">
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="panel panel-yellow">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Emjemplo grafico de pastel</h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-red">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i>Graficos de lineas con ejemplos</h3>
                            </div>
                            <div class="panel-body">
                    ...
                    <div class="col-lg-4">
                        <div class="panel panel-primary">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right"></i> Graficos de barra</h3>
                            </div>
                            <div class="panel-body">
