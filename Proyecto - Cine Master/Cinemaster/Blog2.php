  ...
  <li role="presentation"><a href="Blog2.php?nombre=promocion">Promociones<span class="badge">4</span></a></li>
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="cambiar.php">Cambiar contrase&ntildea</a></li>
             <li role="separator" class="divider"></li>
             <li><a href="Todo.html" role="button">Politicas de usuario</a></li>
              <li role="separator" class="divider"></li>
            <li><a href="cambiar_user.php" role="button">Cambiar Usuario</a></li>
             <li role="separator" class="divider"></li>
              <li><a href="cerrar.php" role="button" >Cerrar sesion</a></li>
          </ul>
      <li><a></a></li>
    </ul>
    </div><!-- /.navbar-collapse -->
...
<div class="container-fluid">
  <div class="row content">
    <div class="col-sm-3 sidenav">
      <a><i class="fa fa-user aria-hidden='true' fa-5x"></i><a class="btn btn-success" role="button" data-toggle="modal" data-target="#myModal"><?php echo $_SESSION['user']?></a>
      <br>
      <ul class="nav nav-pills nav-stacked">
       <br>
        <li class=""><a href="Blog2.php"><i class="fa fa-home aria-hidden='true' fa-5x" > </i> <span class="label label-primary">Inicio</span></a></li>
         <li class=""><a href="tienda.php"><i class="fa fa-film aria-hidden='true' fa-4x "></i><span class="label label-info">Peliculas</span></a></li>
...
$us = $_SESSION['user'];
$query = mysqli_query($conexion, "SELECT P.NOMBRE_P TITULO, PS.ID_SALA, U.USER_NAME USER, DATE_FORMAT(UP.FECHA_RESERVA,'%b %d %Y %h:%i %p') FECHA,  UP.COD_USER ID, DATE_FORMAT(PS.HORARIO,'%b %d %Y %h:%i %p') HORARIO FROM usuarios U, u_peliculas UP, peliculas P, p_salas PS
...
while($row = mysqli_fetch_assoc($query)){
 ...
 echo "<tr>
    <td><span class='text text-success'><b>$titulo</b></span></td>
    <td><span class='text text-success'><b>$usuario</b></span></td>
    <td><span class='text text-success'><b>$horario</b></span></td>
    <td><span class='text text-success'><b>$sala</b></span></td>
    <td><span class='text text-success'><b>$code</b></span></td>
  </tr>";
    ...
    <div class='modal-dialog'>";
     ...
     echo "<div class='modal-content'>
        ...
        <div class='modal-header'>
          ...
          <h3 class='modal-title text text-danger text-center'>$usuario</h3>
        </div>";
...
$result = mysqli_query($conexion, "SELECT * FROM usuarios where USER_NAME='$usuario'");

if (mysqli_num_rows($result) > 0) {
    // output data of each row
  while($row = mysqli_fetch_assoc($result)){
       $nombre=$row['NOMBRES_U'];
        $apellido=$row['APELLIDOS_U'];
        $correo=$row['CORREO_U'];
        $sexo=$row['SEXO'];
...
mysqli_close($conexion);
        ...
        echo "<div class='modal-body'>
          <h3 class='text text-success'>Nombre/s: <b>$nombre</b></h3>
          <h3 class='text text-success'>Apellido/s: <b>$apellido</b></h3>
          <h3 class='text text-success'>Correo:  <b>$correo</b></h3>
           <h3 class='text text-success'>Sexo:  <b>$sexo</b></h3>
        </div>";
...
<footer id="main-footer">
    <div class="container">
      ...
      <div class="col-xs-12 col-sm-5">
        <h3>Cinemaster</h3>
        <p>Sitio Web de cinematografia.</p>
